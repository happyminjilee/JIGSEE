...
export default function RequestList() {
  ...
  const { id, creator, status, updatedAt, createdAt, jigItemInfo, checkList } =
    useWoDetailStore();
    ...
    <>
      <div className={styled.box}>
        ...
        >
          ...
          <div style={{ margin: "auto 40px auto 0px" }}>
            <ArrowForwardIosIcon />
          </div>
        </div>
        ...
        <div className={styled.third}>
          <div className={styled.title}>수리 진행 상황</div>
          <div className={styled.middleBox}>
